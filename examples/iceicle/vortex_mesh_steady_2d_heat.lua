-- Example: Steady state heat equation in 2D on a twisted mesh
-- Author: Gianni Absillis
--
-- Solves the academic problem of a 2D heat equation with dirichlet boundary conditions.
-- With error analysis
-- The mesh is comprised of second order quad elements which have been twisted to follow a taylor-green vortex
